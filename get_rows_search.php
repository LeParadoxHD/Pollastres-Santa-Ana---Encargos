<?php
	...
	$sql = "SELECT Nombre, Conejos, Pollos, Mpollos, Caliu, Butifarras, Galtas, Costillas, Pies, alioli, Hora, Notas, Pagado, Separado, Tachado FROM encargos WHERE Nombre LIKE '%{$_GET[termino]}%' OR Conejos LIKE '%{$_GET[termino]}%' OR Pollos LIKE '%{$_GET[termino]}%' OR Mpollos LIKE '%{$_GET[termino]}%' OR Caliu LIKE '%{$_GET[termino]}%' OR Butifarras LIKE '%{$_GET[termino]}%' OR Galtas LIKE '%{$_GET[termino]}%' OR Costillas LIKE '%{$_GET[termino]}%' OR Pies LIKE '%{$_GET[termino]}%' OR alioli LIKE '%{$_GET[termino]}%' OR Hora LIKE '%{$_GET[termino]}%' OR Notas LIKE '%{$_GET[termino]}%' OR Pagado LIKE '%{$_GET[termino]}%'";
